...
exports.tarifes = {
  Barelona: {
    Catala: {
      ...
      'T-10': {nomTarifa: 'T-10', tipusTarifa: 'AbonamentsIntegrats', descripcio: "Títol multipersonal vàlid per fer 10 desplaçaments integrats d'1 a 6 zones, en què es disposa, en el cas d'un títol d'una zona, de 75 minuts entre la primera i l'última validació. El termini s'incrementa 15 minuts per cada zona.",
        preuZona: {
          zona1: {preu: '9.95€'},
          zona2: {preu: '19.60€'},
          zona3: {preu: '26.75'},
      ...
      'T-Mes': {nomTarifa: 'T-Mes', tipusTarifa: 'AbonamentsIntegrats', descripcio: "Títol personal i intransferible vàlid per fer un nombre il·limitat de viatges durant 30 dies consecutius des de la primera validació. Ha d'anar acompanyat del DNI o de carnets acreditatius dels operadors. El número del document que serveixi com a acreditació ha de figurar imprès al títol.",
        preuZona: {
          zona1: {preu: '52.75€'},
          zona2: {preu: '77.45€'},
          zona3: {preu: '105'},
      ...
      'T-50/30': {nomTarifa: 'T-50/30', tipusTarifa: 'AbonamentsIntegrats', descripcio: "Títol unipersonal vàlid per fer 50 desplaçaments integrats en 30 dies consecutius a partir de la primera validació, en què es disposa, en el cas d'un títol d'una zona, de 75 minuts entre la primera i l'última validació. El termini s'incrementa 15 minuts per cada zona.",
        preuZona: {
          zona1: {preu: '42.50€'},
          zona2: {preu: '71€'},
          zona3: {preu: '99.60€'},
      ...
      'T-70/30': {nomTarifa: 'T-70/30', tipusTarifa: 'AbonamentsIntegrats', descripcio: "Títol multipersonal vàlid per fer 70 viatges en 30 dies consecutius des de la primera cancel·lació, en què es disposa, en el cas d'un títol d'una zona, de 75 minuts entre la primera i l'última validació. El termini s'incrementa 15 minuts per cada zona.",
        preuZona: {
          zona1: {preu: '59.50€'},
          zona2: {preu: '86.05€'},
          zona3: {preu: '118€'},
      ...
      TelefèricDeMontjuïc: {nomTarifa: 'TelefèricDeMontjuïc', tipusTarifa: 'Turisme', descripcio: 'Fes la teva reserva online, imprimeix-la i mostra-la a les taquilles de qualsevol de les estacions del telefèric per canviar-la pels bitllets.',
        preuPersona: {
          Adult: {preu: '10.35€'},
          'Nens4-12': {preu: '7.56€'},
          Nens4: {preu: '0.0€'}
    ...
    Castella: {
      ...
      TeleféricoDeMontjuïc: {nomTarifa: 'TeleféricoDeMontjuïc', tipusTarifa: 'Turismo', descripcio: 'Haz tu reserva online, imprímela y muéstrala en las taquillas de cualquiera de las estaciones del teleférico para canjearla por los billetes.',
        preuPersona: {
          Adult: {preu: '10.35€'},
          'Nens4-12': {preu: '7.56€'},
          Nens4: {preu: '0.0€'}
    ...
    Angles:{
      ...
      TelefèricDeMontjuïc: {nomTarifa: 'TelefèricDeMontjuïc', tipusTarifa: 'Tourism', descripcio: 'Book online, print out your reservation and present it at the ticket office of any of the Teléferic stations to exchange for your tickets.',
        preuPersona: {
          Adult: {preu: '10.35€'},
          'Nens4-12': {preu: '7.56€'},
          'Nens4': {preu: '0.0€'}
